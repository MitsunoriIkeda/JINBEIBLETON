        ...
        <AnimatePresence>
            {isDragging && (
                <motion.div 
                    ...
                    exit={{ opacity: 0 }}
                >
                    <img src="./assets/dog.png" style={{ width: '15vw', filter: transcriptionEngine === 'mt3' ? 'hue-rotate(280deg) brightness(1.5)' : transcriptionEngine === 'muscriptor' ? 'hue-rotate(120deg) brightness(1.3)' : 'hue-rotate(180deg)' }} className="floating" alt="Drag Dog" />
                    ...
                    {transcriptionEngine === 'muscriptor' && <p className="retro-text label-small" style={{ color: '#00ffcc', marginTop: '10px' }}>{">>>"} MULTI-INSTRUMENT SOTA MODE (MUSCRIPTOR)</p>}
                </motion.div>
            )}
        </AnimatePresence>
    );
