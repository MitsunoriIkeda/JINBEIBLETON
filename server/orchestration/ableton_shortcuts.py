...
ABLETON_SHORTCUTS = [
    ...
    {"keywords": ["再生", "プレイ", "play", "ストップ", "停止"], "shortcut": "Space", "description": "再生と停止の切り替え"},
    {"keywords": ["再開", "resume"], "shortcut": "Shift+Space", "description": "停止位置から再生を再開"},
    {"keywords": ["録音", "record"], "shortcut": "F9", "description": "録音のオン/オフ"},
    ...
    # ===== 41.25 Momentary Latching (Live 12 New!) =====
...
def search_shortcuts(query: str, max_results: int = 5) -> list:
    ...
    # Clean query: remove generic noise words that cause false positives
    noise_words = ["ショートカット", "shortcut", "教えて", "ください", "の", "は", "？", "か", "を"]
